...
class Book_category_masters extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout->navTitle = 'Book category master list';
        $this->layout->title = 'Book category master list';
        $header = array(
            array(
                'db_column' => 'name',
                'name' => 'Name',
        ...
        $grid_buttons[] = array(
            'btn_class' => 'btn-info',
            'btn_href' => base_url('library/book_category_masters/view'),
            'btn_icon' => 'fa-eye',
        ...
        $grid_buttons[] = array(
            ...
            'btn_href' => base_url('library/book_category_masters/edit'),
            'btn_icon' => 'fa-pencil',
        ...
        $dt_tool_btn = array(
            array(
                'btn_class' => 'btn-primary',
                'btn_href' => base_url('library/book_category_masters/create'),
                'btn_icon' => '',
                'btn_title' => 'Create',
                'btn_text' => 'Create',
                'btn_separator' => ' '
        ...
        $config = array(
            ...
            'dt_header' => $header,
            'dt_ajax' => array(
                'dt_url' => base_url('library/book_category_masters/index'),
            ),
    ...
    public function export_grid_data() {
        if ($this->input->is_ajax_request()):
            ...
            $tableHeading = array('name' => 'name', 'code' => 'code', 'status' => 'status', 'parent_id' => 'parent_id', 'created' => 'created', 'created_by' => 'created_by',);
            $cols = 'name,code,status,parent_id,created,created_by';
        ...
        if ($this->input->post()):
            ...
            if ($this->form_validation->run()):
                ...
                if ($result >= 1):
                    ...
                    redirect('/library/book_category_masters');
                else:
