...
class Book_author_masters extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout->navTitle = 'Book author master list';
        $this->layout->title = 'Book author master list';
        $header = array(
            array(
        ...
        $grid_buttons[] = array(
            'btn_class' => 'btn-info',
            'btn_href' => base_url('library/book_author_masters/view'),
            'btn_icon' => 'fa-eye',
        ...
        $grid_buttons[] = array(
            ...
            'btn_href' => base_url('library/book_author_masters/edit'),
            'btn_icon' => 'fa-pencil',
        ...
        $dt_tool_btn = array(
            array(
                'btn_class' => 'btn-primary',
                'btn_href' => base_url('library/book_author_masters/create'),
                'btn_icon' => '',
                'btn_title' => 'Create',
                'btn_text' => 'Create',
                'btn_separator' => ' '
        ...
        $config = array(
            ...
            'dt_header' => $header,
            'dt_ajax' => array(
                'dt_url' => base_url('library/book_author_masters/index'),
            ),
    ...
    public function export_grid_data() {
        if ($this->input->is_ajax_request()):
            ...
            $worksheet_name = 'book_author_masters';
            $file_name = 'book_author_masters' . date('d_m_Y_H_i_s') . '.' . $export_type;
            $config = array(
                'db_data' => $data['aaData'],
                'header_rows' => $header,
    ...
    public function create() {
        ...
        $this->layout->navTitle = 'Book author master create';
        $data = array();
        if ($this->input->post()):
            $config = array(
                array(
            ...
            if ($this->form_validation->run()):
                ...
                if ($result >= 1):
                    ...
                    redirect('/library/book_author_masters');
                else:
    ...
    public function edit($bauthor_id = null) {
        ...
        $this->layout->navTitle = 'Book author master edit';
        $data = array();
        if ($this->input->post()):
            $data['data'] = $this->input->post();
            $config = array(
    ...
    public function view($bauthor_id) {
        ...
        if ($bauthor_id):
            ...
            $this->layout->navTitle = 'Book author master view';
