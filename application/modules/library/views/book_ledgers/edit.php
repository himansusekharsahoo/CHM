            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class = 'form-group row'>
                        <label for = 'book_id' class = 'col-sm-4 col-form-label'>Book id</label>
                        <div class = 'col-sm-7'>
                            <?php
                            $attribute = array(
                                "name" => "book_id",
                    ...
                    <div class = 'form-group row'>
                        <label for = 'bcategory_id' class = 'col-sm-4 col-form-label'>Bcategory id</label>
                        <div class = 'col-sm-7'>
                            <?php
                            $attribute = array(
                                "name" => "bcategory_id",
                    ...
                    <div class = 'form-group row'>
                        <label for = 'bpublication_id' class = 'col-sm-4 col-form-label'>Bpublication id</label>
                        <div class = 'col-sm-7'>
                            <?php
                            $attribute = array(
                    ...
                    <div class = 'form-group row'>
                        <label for = 'bauthor_id' class = 'col-sm-4 col-form-label'>Bauthor id</label>
                        <div class = 'col-sm-7'>
                            <?php
                            $attribute = array(
                                "name" => "bauthor_id",
                    ...
                    <div class = 'form-group row'>
                        <label for = 'blocation_id' class = 'col-sm-4 col-form-label'>Blocation id</label>
                        <div class = 'col-sm-7'>
                            <?php
                            $attribute = array(
                                "name" => "blocation_id",
