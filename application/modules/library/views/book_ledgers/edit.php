<div class="col-sm-6">
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class = 'form-group row'>
                <label for = 'bcategory_id' class = 'col-sm-3 col-form-label'>Bcategory id</label>
                <div class = 'col-sm-5'>
                    <?php
                    $attribute = array(
                        "name" => "bcategory_id",
            ...
            <div class = 'form-group row'>
                <label for = 'bpublication_id' class = 'col-sm-3 col-form-label'>Bpublication id</label>
                <div class = 'col-sm-5'>
                    <?php
                    $attribute = array(
            ...
            <div class = 'form-group row'>
                <label for = 'bauthor_id' class = 'col-sm-3 col-form-label'>Bauthor id</label>
                <div class = 'col-sm-5'>
                    <?php
                    $attribute = array(
                        "name" => "bauthor_id",
            ...
            <div class = 'form-group row'>
                <label for = 'blocation_id' class = 'col-sm-3 col-form-label'>Blocation id</label>
                <div class = 'col-sm-5'>
                    <?php
                    $attribute = array(
                        "name" => "blocation_id",
            ...
            <div class = 'form-group row'>
                <label for = 'isbn_no' class = 'col-sm-3 col-form-label'>Isbn no</label>
                <div class = 'col-sm-5'>
                    <?php
                    $attribute = array(
                        "name" => "isbn_no",
