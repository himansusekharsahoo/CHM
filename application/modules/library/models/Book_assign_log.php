...
class Book_assign_log extends CI_Model {
    ...
    public function get_book_assign_log_datatable($data = null, $export = null, $tableHeading = null, $columns = null) {
        ...
        if (!$columns) {
            $columns = 'bassign_id,bledger_id,user_id,user_type,issue_date,due_date,return_date,return_delay_fine,book_return_condition,book_lost_fine,remarks,created,created_by';
        }
