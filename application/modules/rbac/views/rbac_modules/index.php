<?php if ($this->rbac->has_permission('RBAC_MODULE', 'create')): ?>
<div class="pull-right" id="create_button_div">
    <a class="btn btn-primary btn-sm" href="<?= APP_BASE ?>rbac/rbac_modules/create">Create</a>
</div>
<?php endif;?>

<div class="table-responsive">
    <?php
    generate_gird($grid_config, "rbac_modules_list");
    ?>
        ...
        $(document).on('click', '.delete-record', function (e) {
            ...
            BootstrapDialog.show({
                ...
                buttons: [{
                        ...
                        action: function (dialog) {
                            $.ajax({
                                url: '<?= APP_BASE ?>rbac/rbac_modules/delete',
                                method: 'POST',
                                data: data,
