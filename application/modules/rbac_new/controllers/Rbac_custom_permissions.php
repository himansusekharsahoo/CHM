...
$this->load->model('rbac_custom_permission');$this->load->library('pagination');$this->load->library('form_validation');
...
public function index($export=0){
        ...
        $this->breadcrumbs->push('index','/rbac_new/rbac_custom_permissions/index');
        ...
        $buttons[] = array(
            'btn_class' => 'btn-info',
            'btn_href' => base_url('rbac_new/rbac_custom_permissions/view'),
            'btn_icon' => 'fa-eye',
        ...
        $buttons[] = array(
            ...
            'btn_href' => base_url('rbac_new/rbac_custom_permissions/edit'),
            'btn_icon' => 'fa-pencil',
        ...
        $config['grid_config'] = array(
            ...
            'grid' => array(
                'ajax_source' => 'rbac_new/rbac_custom_permissions/index',
            ...
            'table_tools' => array(
                'xls' => array(
                    'url' => 'rbac_new/rbac_custom_permissions/index/xls'
                ), 'csv' => array(
                    'url' => 'rbac_new/rbac_custom_permissions/index/csv'
                )
            )
        );
        $data['data'] = $config;
...
$this->breadcrumbs->push('create','/rbac_new/rbac_custom_permissions/create');
...
array(
	 ...
	 redirect('/rbac_new/rbac_custom_permissions');
	 else:
...
$this->breadcrumbs->push('edit','/rbac_new/rbac_custom_permissions/edit');

$this->layout->navTitle='Rbac custom permission edit';$data=array();
	 if($this->input->post()):
	 $data['data']=$this->input->post();
	 $config = array(
array(
...
$this->breadcrumbs->push('view','/rbac_new/rbac_custom_permissions/view');

$data=array();
	 if($custom_permission_id):
	 $custom_permission_id=c_decode($custom_permission_id);

	 $this->layout->navTitle='Rbac custom permission view';$result = $this->rbac_custom_permission->get_rbac_custom_permission(null, array('custom_permission_id' => $custom_permission_id),1);
	 if($result):
	 $result = current($result);
	 endif;
