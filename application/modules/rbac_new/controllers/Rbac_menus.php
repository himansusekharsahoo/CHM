...
$this->load->model('rbac_menu');$this->load->library('pagination');$this->load->library('form_validation');
...
$this->layout->navTitle='Rbac menu edit';$data=array();
	 if($this->input->post()):
	 $data['data']=$this->input->post();
	 $config = array(
array(
...
$data=array();
	 ...
	 $this->layout->navTitle='Rbac menu view';$result = $this->rbac_menu->get_rbac_menu(null, array('menu_id' => $menu_id),1);
	 if($result):
	 $result = current($result);
	 endif;
