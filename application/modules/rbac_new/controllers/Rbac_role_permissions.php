...
class Rbac_role_permissions extends CI_Controller {
    ...
    public function index() {
        ...
        $dt_tool_btn = array(
            array(
                'btn_class' => 'btn-primary',
                'btn_href' => base_url('rbac_new/rbac_role_permissions/create'),
                'btn_icon' => '',
                'btn_title' => 'Create',
                'btn_text' => 'Create',
                'btn_separator' => ' '
        ...
        $config = array(
            ...
            'dt_header' => $header,
            'dt_ajax' => array(
                'dt_url' => base_url('rbac_new/rbac_role_permissions/index'),
            ),
    ...
    public function export_grid_data() {
        if ($this->input->is_ajax_request()):
            ...
            $cols = 'role_id,permission_id,status,created,modified';
            $data = $this->rbac_role_permission->get_rbac_role_permission_datatable(null, true, $tableHeading);
            ...
            $worksheet_name = 'rbac_role_permissions';
            $file_name = 'rbac_role_permissions' . date('d_m_Y_H_i_s') . '.' . $export_type;
            $config = array(
                'db_data' => $data['aaData'],
                'header_rows' => $header,
