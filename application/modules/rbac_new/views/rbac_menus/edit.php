...
$form_action= "/rbac_new/rbac_menus/edit";
...
"required"=>"", 
"type"=>"hidden", 
"value" => (isset($data["menu_id"]))?$data["menu_id"]:""
); 
echo form_error("menu_id"); echo form_input($attribute); ?><div class = 'form-group row'>
...
echo form_error("menu_order"); echo form_input($attribute); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("parent"); echo form_input($attribute); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("icon_class"); echo form_input($attribute); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("menu_class"); echo form_input($attribute); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("attribute"); echo form_input($attribute); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("url"); echo form_input($attribute); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
                ...
                "title" => "",
"required"=>"", 
); $menu_type=(isset($data['menu_type']))?$data['menu_type']:'';echo form_error("menu_type");echo form_dropdown($attribute,$menu_type_list,$menu_type); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
