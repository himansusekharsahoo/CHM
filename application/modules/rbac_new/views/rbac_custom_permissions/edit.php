...
$form_action= "/rbac_new/rbac_custom_permissions/edit";
...
echo form_error("custom_permission_id"); echo form_input($attribute); ?><div class = 'form-group row'>
...
<div class = 'form-group row'>
                ...
                "title" => "",
"required"=>"", 
); $assigned_by=(isset($data['assigned_by']))?$data['assigned_by']:'';echo form_error("assigned_by");echo form_dropdown($attribute,$assigned_by_list,$assigned_by); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
<div class = 'form-group row'>
<div class = 'col-sm-1'>
<a class="text-right btn btn-default" href="<?=APP_BASE?>rbac_new/rbac_custom_permissions/index">
