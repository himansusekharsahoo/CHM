<div style="float:right;"><a class="btn btn-primary btn-sm" href="<?=APP_BASE?>rbac_new/rbac_user_roles/create">Create</a></div>
<div class="row-fluid">
                <?php
...
$(document).on('click','.delete-record',function(e){
                    ...
                    BootstrapDialog.show({
                        ...
                        buttons: [{
                                ...
                                action: function (dialog) {
                                    $.ajax({
                                        url: '<?=APP_BASE?>rbac_new/rbac_user_roles/delete',
                                        method: 'POST',
                                        data: data,
