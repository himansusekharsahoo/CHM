...
class Scripts_include {
    ...
    private $__appJsFiles = array(
        ...
        'datatable' => array(
            ...
            COMPONENT_PATH . 'datatables-autofill/dataTables.autoFill.js',
            COMPONENT_PATH . 'datatables-colreorder/js/dataTables.colReorder',
            COMPONENT_PATH . 'datatables-fixedcolumns/js/dataTables.fixedColumns',
            COMPONENT_PATH . 'datatables-keytable/js/dataTables.keyTable',
            COMPONENT_PATH . 'datatables-scroller/js/dataTables.scroller',
